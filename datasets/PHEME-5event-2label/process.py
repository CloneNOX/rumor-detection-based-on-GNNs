...
DATA_PATH = '../../../dataset/PHEME/PHEME-9/all-rnr-annotated-threads/'
EVENT_NAME = [
    'charliehebdo', 
    'ferguson', 
    'germanwings-crash', 
...
label2Index = {'non-rumor': 0, 'rumor': 1}
index2Label = {'0': 'non-rumor', '1': 'rumor'}
...
def ProcessRNRDataset():
    ...
    for event in eventName:
        if '.' in event or 'README' in event: continue
        if event.split('-all-rnr-threads')[0] not in EVENT_NAME: continue
